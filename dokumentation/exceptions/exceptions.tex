...
\noindent
'IllegalArgumentException' ist hierbei der Typ des Fehlers. Dieser Typ wird ausgelöst, wenn eine Funktion einen ungültigen Wert übergeben bekommen hat. '\enquote{Ungültiger Parameter. }+param' ist die Fehlermeldung, die möglichst aussagekräftig sein sollte, um sofort auf den Grund des Fehlers schließen zu können.
