...
public final class GlobalConstants
{
    ...
    public static final double MAX_X = 800;
    public static final double MAX_Y = 400;

    public static final double FRICTION_FACTOR = 200d;
    public static final double COLLISION_IMPULSE_LOSS = 0.01d;

    public static final String BG_IMAGE_FILENAME = "src/main/resources/images/board.png";
