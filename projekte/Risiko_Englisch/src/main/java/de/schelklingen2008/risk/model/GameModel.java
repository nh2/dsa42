...
public class GameModel implements Serializable
{
    ...
    private Country[] island      = new Country[3];
    private Country[] scandinavia = new Country[4];
    private Country[] northEast   = new Country[7];
    private Country[] southEast   = new Country[6];
    private Country[] west        = new Country[3];
    private Country[] central     = new Country[7];
    ...
    {
        // init island
        island[0] = c[2];// Groﬂbritanien
        island[1] = c[1]; // Irland
        island[2] = c[0]; // Island

        // init scandinavia
        scandinavia[0] = c[3];// Norwegen
        scandinavia[1] = c[4];// Finnland
        scandinavia[2] = c[5];// Schweden
        scandinavia[3] = c[6];// D‰nemark

        // init North-East
        northEast[0] = c[7];// Russland
        northEast[1] = c[8];// Estland
        northEast[2] = c[9];// Lettland
        northEast[3] = c[10];// Litauen
        northEast[4] = c[11];// Weiﬂrussland
        northEast[5] = c[12];// Ukraine
        northEast[6] = c[13];// Polen

        // init South-East
        southEast[0] = c[14];// Italien
        southEast[1] = c[15];// Griechenland
        southEast[2] = c[16];// Jugoslawien
        southEast[3] = c[17];// Albanien
        southEast[4] = c[18];// Bulgarien
        southEast[5] = c[19];// Rum‰nien
        ...
        // init Central
        central[0] = c[23];// BeNeLux
        central[1] = c[24];// Deutschland
        central[2] = c[25];// Tschechien
        central[3] = c[26];// Schweiz
        central[4] = c[27];// Slowakei
        central[5] = c[29];// Ungarn
        central[6] = c[28];// ÷sterreich
    ...
    private void initCountrys()
    {
        ...
        c[19] = new Country("Romania", 19, 688, 758, 128, 0, 128);
    ...
    private void initNeigbours()
    {
        ...
        griechenland.add(3, c[19]);// Rum‰nien
    ...
    public void placeUnit(Country c)
    {
        ...
        history[0] = "Places army in " + c.getName();
        history[1] = null;
    ...
    public void attack(Country attacker, Country defender)
    {
        ...
        history[1] = "Loss  " + attlostunits + "  -  " + deflostunits;
